...
export const clothingSearchTerms: SearchTermMapping = {
  // Base layers
  'thermalUnderwear': ['thermal base layer fashion', 'thermal wear winter', 'thermal clothing'],
  'longSleeveUndershirt': ['base layer fashion', 'undershirt style', 'long sleeve undershirt'],
  
  // Upper body - Shirts
  'thermalShirt': ['thermal shirt fashion', 'thermal top winter', 'thermal wear'],
  'longSleeveShirt': ['long sleeve shirt fashion', 'button up shirt', 'dress shirt'],
